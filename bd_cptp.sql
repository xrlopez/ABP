...
(4, 'tosta de hamburguesa', 'tosta de mini hamburquesa de ternera con queso de tetilla', 0, 1, 3, 'pinchosOurense', 'tamega'),
...
(7, 'Hojaldre con paté de perdiz', 'Maravilloso paté de perdiz, manzana y trufa sobre una fina capa de hojaldre', 0, 1, 1, 'pinchosOurense', 'cafeRubi'),
(8, 'pimientos con salsa', 'Fabulosos pimientos del piquillo con salsa de ostras', 0, 0, 0, 'pinchosOurense', 'BeerParaCreer'),
(9, 'Calamares encebollados', 'Calamares encebollados al albariño con jamón', 0, 0, 0, 'pinchosOurense', 'cafeDulce'),
(10, 'Higos, mozzaralla y albahaca', 'Brocheta de higos, mozzarella y albahaca aderezados con aceita de oliva', 1, 0, 0, 'pinchosOurense', 'laCantina36'),
(11, 'Pinchos de melón con anchoa y mermelada de cebolla', 'Combinación de sabores dulces y salados que resulta elegante al paladar', 1, 1, 1, 'pinchosOurense', 'ElPaso10'),
(12, 'Huevos rellenos', 'Deliciosos huevos rellenos de boletus y trufa', 0, 0, 0, 'pinchosOurense', 'elChiringuito85'),
(13, 'Corte de mousse', 'Magnífico corte de mousse de foie y boniato', 0, 0, 0, 'pinchosOurense', 'granVia27'),
(14, 'Pincho de tortilla de patata', 'Pinchos de tortilla de patata violeta con cebolla caramelizada y cabrales', 1, 0, 0, 'pinchosOurense', 'laParada5'),
(15, 'Seta de cardo', 'Rica seta de cardo confitada con romero y ajo', 1, 1, 0, 'pinchosOurense', 'laPlaza74'),
(16, 'Tramezzini', 'Tramezzini con pavo ahumado y pesto trapanese', 0, 0, 0, 'pinchosOurense', 'casablanca_86'),
(17, 'Palitos de polenta', 'Palitos de polenta con parmesano y romero', 0, 0, 0, 'pinchosOurense', 'mundo_92'),
(18, 'Hojas de cogollo con aguacate y tomate', 'Fabulosas hojas de cogollo con aguacate, tomate y maíz', 0, 1, 0, 'pinchosOurense', 'elquetedije50'),
(19, 'Sepia con jenjibre', 'Sepia con jenjibre y leche de coco', 1, 0, 0, 'pinchosOurense', 'porCopas2'),
