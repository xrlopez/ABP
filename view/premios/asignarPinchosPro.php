	...
	<div class="divLogin col-xs-12 col-sm-12 col-md-12">
		<h2>Elige el pincho a premiar</h2>
					<form id="asignarPinchos2" action="index.php?controller=premios&amp;action=asignar" method="post" >
						...
						?>
						<p><input type="radio" name="id_pincho" id="id_pincho" value="<?= $pincho->getId() ?>" checked><?php echo $pincho->getNombre() ." por ". $pincho->getNombreEstablecimiento() . " con " . $pincho->getVotPro() . " votos. "?></p>
						<?php
						}
						?>
